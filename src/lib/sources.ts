...
export const SEED_SOURCES: Array<{
  ...
  // Tier-1 — additional commentary and summaries
  {
    name: "Yoshua Bengio's Blog",
  ...
  {
    name: "Paul Christiano (Medium)",
    url: "https://medium.com/feed/@paulfchristiano",
    tier: "TIER_1",
    trustWeight: "0.7",
    cadence: "weekly",
    domainType: "commentary",
